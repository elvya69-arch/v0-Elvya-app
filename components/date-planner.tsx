...
const dateSpots = {
 ...
 return (
 <Box sx={{ minHeight: "100vh" }} className="bg-elvyaGold-10 flex ">
 <Paper
 elevation={0}
 sx={{
 // background: "ElvyaGold-100",
 pb: 8,
 px: 2,
 textAlign:'center'
 }}
 className="bg-elvyaGold-10 flex items-center w-[50%]"
 >
 ...
 className="text-elvyaGold-500 eyesome-regular"
 >
 Find Your Perfect Date Spot
 </Typography>
 <Typography variant="h6" sx={{ fontSize: "1.1rem", lineHeight: 1.6 }} className="text-elvyaGreen-500 nunito-Regular">
